...
M.base_30 = {
  ...
  darker_black = "#0d0f08", -- أسود أغمق للتباين
  black2 = "#1b1c15", -- أسود أفتح قليلاً

  -- خلفيات متدرجة بتباين واضح
  one_bg = "#1f2019", -- خلفية العناصر
  one_bg2 = "#292b23", -- خلفية العناصر المرتفعة
  one_bg3 = "#34352d", -- خلفية العناصر العالية
  lightbg = "#46483c", -- خلفية خفيفة
  statusline_bg = "#13140d", -- خلفية شريط الحالة
  line = "#46483c", -- لون الخطوط والحدود

  -- ألوان النص بتباين عالي
  light_grey = "#e4e3d7", -- نص فاتح
  grey_fg2 = "#c7c8b8", -- نص متوسط
  grey_fg = "#c7c8b8", -- نص رمادي
  grey = "#909283", -- نص رمادي غامق
  ...
  orange = "#214e46", -- حاوية اللون الثلاثي
  baby_pink = "#93000a", -- حاوية لون الخطأ

  -- ألوان إضافية مشرقة
  nord_blue = "#3f4c0b", -- حاوية اللون الأساسي
  dark_purple = "#444930", -- حاوية اللون الثانوي
  teal = "#566422", -- اللون الأساسي المعكوس
  ...
  -- ألوان مميزة إضافية
  cyan = "#214e46", -- لون مميز إضافي
  sun = "#a1d0c5", -- لون مشرق
  vibrant_green = "#c4caa9", -- أخضر مشرق
  seablue = "#3f4c0b", -- أزرق بحري
}
...
M.base_16 = {
  ...
  base01 = "#1b1c15", -- خلفية أفتح (أشرطة الحالة، أرقام الأسطر)
  base02 = "#1f2019", -- خلفية التحديد

  -- ألوان النص بتباين عالي
  base03 = "#909283", -- التعليقات، العناصر غير المرئية
  base04 = "#c7c8b8", -- نص أمامي داكن (أشرطة الحالة)
  base05 = "#e4e3d7", -- النص الأمامي الافتراضي، المؤشر، المحددات
  base06 = "#e4e3d7", -- نص أمامي فاتح
  base07 = "#e4e3d7", -- خلفية فاتحة (نادرة الاستخدام)
  ...
  base0A = "#214e46", -- الفئات، النص الغامق، خلفية نص البحث
  base0B = "#c4caa9", -- السلاسل النصية، الفئات الموروثة، الشفرة
  base0C = "#444930", -- الدعم، التعبيرات العادية، أحرف الهروب
  base0D = "#bdce80", -- الوظائف، الطرق، معرفات السمات، العناوين
  base0E = "#3f4c0b", -- الكلمات المفتاحية، التخزين، المحدد
